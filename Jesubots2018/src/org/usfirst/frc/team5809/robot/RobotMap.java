...
public class RobotMap {
	...
	/*
	 * public static int frontLeftCAN = 7;//5;
	public static int frontRightCAN = 5;//7;
	public static int backLeftCAN = 1;//0;
	public static int backRightCAN = 0;//1;
	public static int midLeftCAN = 3;//4;
	public static int midRightCAN = 4;//3;
	 */
	public static int frontLeftCAN = 6;
	...
	public static double defaultOppositeJawsPower = -.65;
	...
	public static double defaultLiftPower = .85;
	...
	public static class EncoderDistanceMap {
		...
		public static final double kNearSideSeg2 = 10000.0;
	...
	public enum TargetPreference {
		SWITCH, SCALE, SWITCHSIDE, SCALESIDE, NONE;
