...
public class DriveTrain extends Subsystem {
	...
	public void arcadeDrive(double throttle, double turnPower) {
		...
		robotDrive.tankDrive(throttle, turnPower);
	...
	public void DriveTank(double dLeftMag, double dRightMag) {
		...
		setVoltageRampValues(leftMaster.getOutputCurrent(), rightMaster.getOutputCurrent());
		System.out.println("right master value " + dRightMag);
		System.out.println("right master amprage: " + rightMaster.getOutputCurrent());
		
		System.out.println("right mid value " + dRightMag);
		System.out.println("right mid amprage: " + rightFollowerMid.getOutputCurrent());
		
		System.out.println("right back value " + dRightMag);
		System.out.println("right back amprage: " + rightFollowerBack.getOutputCurrent());
		
		System.out.println("left master value " + dLeftMag);
		System.out.println("left master amprage: " + leftMaster.getOutputCurrent());
		
		System.out.println("left mid value " + dLeftMag);
		System.out.println("left mid amprage: " + leftFollowerMid.getOutputCurrent());
		
		System.out.println("left back value " + dLeftMag);
		System.out.println("left back amprage: " + leftFollowerBack.getOutputCurrent());
		/*
		 System.out.println("Amprage right master : " +
		 rightMaster.getOutputCurrent() + ", " +
		 "Amprage right follower mid : " + rightFollowerMid.getOutputCurrent()
		 ...
		 rightMaster.getMotorOutputltage() +
	...
	public void setVoltageRampValues(double left, double right){
		rightOutput = right;
		leftOutput = left;
	}
	
	public double getLeftVoltageValue(){
		return leftOutput;
	}
	
	public double getRightVoltageValue(){
		return rightOutput;
	}
