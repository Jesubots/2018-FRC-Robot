...
public class DestinationAuto extends CommandGroup {
	...
	public DestinationAuto() {
		...
		if (OI.getDestination().getFieldDistance() == eFieldDistance.kUnknown) {
			...
			addSequential(new DriveStraightDistance(10000.0, 2.0));
			addSequential(new PivotTurn(0.65, 90.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()), 1.5, false));
			System.out.println(90.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()));
			addSequential(new DriveStraightDistance(15000.0, 2.0));
			addSequential(new PivotTurn(0.65, 90.0 * -Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()), 1.5, false));
			addParallel(new LiftUp(1.2));
			addSequential(new DriveStraightDistance(20000.0, 2.0));
			addParallel(new SpitJaws());
			addSequential(new DriveStraightDistance(-15000.0, 2.0));
			addParallel(new LiftDown(1.0));
			addSequential(new PivotTurn(0.65, 90.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()), 1.5, false));
			addSequential(new DriveStraightDistance(-11500.0, 2.0));
			addParallel(new ToggleJawsOpen());
			addSequential(new PivotTurn(0.65, 90.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN2.getDriveData()), 1.5, false));
			addParallel(new GrabJaws(3.0));
			addSequential(new DriveStraightDistance(10000.0, 3.0));
			addSequential(new ToggleJawsClose());
			return;
			/*
			addSequential(new DriveStraightDistance(10000.0, 2.0));
			addSequential(new PivotTurn(0.45, 45.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()), 2.0, false));
			System.out.println(45.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()));
			addSequential(new DriveStraightDistance(Destination.NearSideDestination.DRIVE_SEG3.getDriveData(), 2.0));
			addSequential(new PivotTurn(0.45, 45.0 * -Math.signum(Destination.NearSideDestination.DRIVE_TURN1.getDriveData()), 2.0, false));
			addSequential(new LiftUp(.75));
			addSequential(new DriveStraightDistance(5000.0, 1.0));
			addSequential(new SpitJaws());
			addSequential(new DriveStraightDistance(-4000, 1.0));
			addSequential(new LiftDown(.75));
			addParallel(new ToggleJawsOpen());
			addSequential(new PivotTurn(0.8, 90.0 * Math.signum(Destination.NearSideDestination.DRIVE_TURN2.getDriveData()), 1.0, false));
			addSequential(new DriveStraightTime(1.5, .3));
			addParallel(new GrabJaws());
			addSequential(new ToggleJawsClose());
			*/
			/*
			addSequential(new LiftUp(.75));
			addSequential(new DriveStraightTime(1.0, -0.5));
			addSequential(new PivotTurn(.8, 90.0 * -Math.signum(Destination.NearSideDestination.DRIVE_TURN2.getDriveData()), 1.0, false));
			addSequential(new DriveStraightTime(.75, 0.5));
			 */
			
			//addSequential(new PivotTurn(0.45, Destination.NearSideDestination.DRIVE_TURN2.getDriveData(), 2.0, false));
			/*
			...
			addSequential(new PivotTurn(0.35, Destination.FarScaleDestination.DRIVE_TURN1.getDriveData(), 2.0, false));
			...
			addSequential(new DriveStraightDistance(targetDistance, timeout));
			addSequential(new PivotTurn(.4, targetDegree, timeout, false));
			addSequential(new Wait(.1));
			addSequential(new DriveStraightDistance(-5000.0, 1.0));
			addSequential(new LiftUp(1.85));
